# 📚 legado-cli 文档中心 (Documentation Index)
...
| 目录 | 定位说明 | 包含核心内容 |
|---|---|---|
| [`reference/`](reference/) | **常驻架构与技术规格 (SOT)** | 整体 Rust CLI 平台架构、维修适配器设计、流程全景与调度分流矩阵、防卡死决策矩阵 |
| [`guides/`](guides/) | **实操手册与开发指南 (How-To)** | 书源创作 SOP、找站指南、真实 HTML 检查单、规则调试流程 |
...
| [`archive/`](archive/) | **历史报告与旧系统归档** | 早期 Python 试验系统 (`legacy-python-system/`)、历史跑批报告与验收记录（保持历史冻结） |
